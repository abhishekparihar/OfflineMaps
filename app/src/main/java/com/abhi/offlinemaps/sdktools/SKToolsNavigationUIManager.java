...
public class SKToolsNavigationUIManager {
     ...
     */
    private OnClickListener settingsItemsClickListener = new OnClickListener() {
    ...
    protected void inflateNavigationViews(Activity activity) {
        ...
        activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                RelativeLayout.LayoutParams routeOverviewRelativeLayoutParams = new RelativeLayout
                        .LayoutParams
                        (RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
                ...
                reRoutingPanel = (ViewGroup) inflater.inflate(R.layout.element_navigation_rerouting_panel,
                        null,
                        false);
                RelativeLayout.LayoutParams reRoutingPanelParams = new RelativeLayout.LayoutParams
                        (RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
                ...
                searchingForGPSPanel = (ViewGroup) inflater.inflate(R.layout.element_navigation_searching_for_gps_panel,
                        null,
                        false);
                RelativeLayout.LayoutParams searchingForGPSPanelParams = new RelativeLayout.LayoutParams
                        (RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
                reRoutingPanelParams.addRule(RelativeLayout.ALIGN_PARENT_TOP);
                ...
                RelativeLayout.LayoutParams topCurrentAdviceParams = new RelativeLayout.LayoutParams
                        (RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
                ...
                topNextNavigationPanel = (ViewGroup) inflater.inflate(R.layout
                        ...
                        null,
                        false);
                RelativeLayout.LayoutParams nextAdviceParams = new RelativeLayout.LayoutParams
                        (RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
                ...
                RelativeLayout.LayoutParams freeDrivePanelParams = new RelativeLayout.LayoutParams
                        (RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
    ...
    private void inflateBottomPanels() {
        ...
        speedPanel = (ViewGroup) inflater.inflate(R.layout
                ...
                false);
        RelativeLayout.LayoutParams currentSpeedParams = new RelativeLayout.LayoutParams
        ...
        RelativeLayout.LayoutParams compassPanelParams = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        ...
        RelativeLayout.LayoutParams etaGroupPanelsParams = new RelativeLayout.LayoutParams
                (RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
    ...
    public void showSearchingForGPSPanel() {
        ...
        if(backButtonPanel.isClickable() == false)
        {
            ...
            params.addRule(RelativeLayout.BELOW, R.id.navigation_searching_for_gps_panel);
        }
        else {
        }
    }
