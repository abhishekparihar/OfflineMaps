package com.abhi.offlinemaps.util;
...
public class Utils {
    ...
    public static enum MapOption {
        ...
        ROUTING_AND_NAVIGATION, POI_TRACKING, NAVI_UI, ADDRESS_SEARCH, NEARBY_SEARCH, CATEGORY_SEARCH, REVERSE_GEOCODING, MAP_SECTION, NAVIGATION_SECTION, SEARCHES_SECTION, PEDESTRIAN_NAVI, currentMapOption, ONEBOX_SEARCH
    }

    private static enum MapAdvices {
